...
window.editor = grapesjs.init({
    ...
    plugins: ['grapesjs-blocks-basic', 'grapesjs-plugin-forms', 'assembekov-grapes', 'grapesjs-plugin-export', 'grapesjs-navbar'],
    pluginsOpts: {
    ...
    canvas: {
        styles: [
            ...
            //Bootstrap core CSS
            /*"wwwroot/showcase-grapes/assets/vendor/mdb/css/bootstrap.min.css"*/
            "https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.4.1/css/bootstrap.min.css",
            //Material Design Bootstrap
            //"wwwroot/showcase-grapes/assets/vendor/mdb/css/mdb.min.css",
            "https://cdnjs.cloudflare.com/ajax/libs/mdbootstrap/4.18.0/css/mdb.min.css",
            //Your custom styles (for MDB)
            "/showcase-grapes/assets/vendor/mdb/css/style.css"
        ],
        scripts: [
            //jQuery
            //"wwwroot/showcase-grapes/assets/vendor/mdb/js/jquery.min.js",
            "https://cdnjs.cloudflare.com/ajax/libs/jquery/3.4.1/jquery.min.js",
            //Bootstrap tooltips
            //"wwwroot/showcase-grapes/assets/vendor/mdb/js/popper.min.js",
            "https://cdnjs.cloudflare.com/ajax/libs/    popper.js/1.14.4/umd/popper.min.js",
            //Bootstrap core JavaScript
            //"wwwroot/showcase-grapes/assets/vendor/mdb/js/bootstrap.min.js",
            "https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.4.1/js/bootstrap.min.js",
            //MDB core JavaScript
            //"wwwroot/showcase-grapes/assets/vendor/mdb/js/mdb.min.js",
            "https://cdnjs.cloudflare.com/ajax/libs/mdbootstrap/4.18.0/js/mdb.min.js",
            //Your custom scripts (for MDB)
            "/showcase-grapes/assets/vendor/mdb/js/script.js",
            //Custom epayco
            //"/showcase-grapes/assets/vendor/mdb/js/epayco.js",
            //Epayco script
    ...
    $('#sidebar-forms-designs .app-content--sidebar__content').append(
        `
                <button id="1135301" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/forms/4.jpg" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/forms/4.jpg">
                    <a href="#">
    ...
    $('#sidebar-forms-designs .app-content--sidebar__content').append(
        `
                <button  id="1135293" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/forms/3.jpg" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/forms/3.jpg">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>
    ...
    $('#sidebar-forms-designs .app-content--sidebar__content').append(
        `
                <button id="1135267" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/forms/2.jpg" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/forms/2.jpg">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>   
    ...
    $('#sidebar-forms-designs .app-content--sidebar__content').append(
        `
                <button id="1135239" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/forms/1.jpg" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/forms/1.jpg">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>
    ...
    $('#sidebar-forms-designs .app-content--sidebar__content').append(
        `
                <button id="1335322" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/forms/5.png" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/forms/5.png">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>
        ...
        window.selected_form_component ? window.selected_form_component.components(`
                <div class="container my-5 px-0 z-depth-1">
                  ...
                  <section class="p-5 my-md-5 text-center" 
                    style="background-image: url(/showcase-grapes/assets/mdb/img/Photos/Others/background.jpg); background-size: cover; background-position: center center;">
    ...
    $('#sidebar-forms-designs .app-content--sidebar__content').append(
        `
                <button id="1336908" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/forms/6.png" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/forms/6.png">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>
                  ...
                  <section class="dark-grey-text p-5">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-5 mb-4 mb-md-0">
                        ...
                        <div class="view">
                          <img src="/showcase-grapes/assets/mdb/img/illustrations/undraw_Group_chat_unwm.svg" class="img-fluid" alt="smaple image">
                        </div>
    ...
    $('#sidebar-forms-designs .app-content--sidebar__content').append(
        `
            <button id="1337730" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                <img data-src="/showcase-grapes/assets/mdb/img/blocks/forms/7.png" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/forms/7.png">
                <a href="#">
                  <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                </a>
            </button>
    ...
    $('#sidebar-forms-designs .app-content--sidebar__content').append(
        `
                    <button id="1401205" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                        <img data-src="/showcase-grapes/assets/mdb/img/blocks/signup/1.png" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/signup/1.png">
                        <a href="#">
                          <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                        </a>
                    </button>
        ...
        window.selected_form_component ? window.selected_form_component.components(`
                <!-- Main navigation -->
                    <div class="container-fluid mt-3 mb-5">
                      ...
                      <!-- Full Page Intro -->
                      <section style="background-image: url('/showcase-grapes/assets/mdb/img/Photos/Others/images/90.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
    ...
    $('#sidebar-forms-designs .app-content--sidebar__content').append(
        `
                <button id="1401468" type="button" class="btn btn-primary overlay z-depth-1 mb-4">                  
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/signup/2.png" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/signup/2.png">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </div>
    ...
    $('#sidebar-forms-designs .app-content--sidebar__content').append(
        `
                <button id="1401499" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/signup/3.png" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/signup/3.png">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                <button id="1349715" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/9.png" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/9.png">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>
                        ...
                        <div id="carousel-thumb" class="carousel slide carousel-fade carousel-thumbnails" data-ride="carousel">
                          ...
                          <div class="carousel-inner text-center text-md-left" role="listbox">
                            <div class="carousel-item active">
                              <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/17.jpg"
                                alt="First slide" class="img-fluid">
                            </div>
                            <div class="carousel-item">
                              <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/18.jpg"
                                alt="Second slide" class="img-fluid">
                            </div>
                            <div class="carousel-item">
                              <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/19.jpg"
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                <button  id="1305666" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/1.png" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/1.png">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>
                          ...
                          <div class="col-lg-3 col-md-6 mb-4">
                            ...
                            <div class="card card-cascade narrower card-ecommerce">
                              ...
                              <div class="view view-cascade overlay">
                                <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Vertical/1.jpg" class="card-img-top"
                                  alt="sample photo">
                                <a>
...
<!--                                </ul>-->
                          ...
                          <div class="col-lg-3 col-md-6 mb-4">
                            ...
                            <div class="card card-cascade narrower card-ecommerce">
                              <!-- Card image -->
                              <div class="view view-cascade overlay">
                                <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Vertical/2.jpg" class="card-img-top"
                                  alt="sample photo">
                                <a>
<!--                                  <div class="mask rgba-white-slight"></div>-->
                                </a>
                          ...
                          <div class="col-lg-3 col-md-6 mb-4">
                            ...
                            <div class="card card-cascade narrower card-ecommerce">
                              <!-- Card image -->
                              <div class="view view-cascade overlay">
                                <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Vertical/4.jpg" class="card-img-top"
                                  alt="sample photo">
                                <a>
<!--                                  <div class="mask rgba-white-slight"></div>-->
                                </a>
...
<!--                                </ul>-->
                          ...
                          <div class="col-lg-3 col-md-6 mb-4">
                            ...
                            <div class="card card-cascade narrower card-ecommerce">
                              <!-- Card image -->
                              <div class="view view-cascade overlay">
                                <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Vertical/3.jpg" class="card-img-top"
                                  alt="sample photo">
                                <a>
<!--                                  <div class="mask rgba-white-slight"></div>-->
                                </a>
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                <button id="1307089" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/7.png" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/7.png">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>   
                    ...
                    <div class="table-responsive">
                      ...
                      <table class="table product-table mb-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <th scope="row">
                              <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/13.jpg" alt="" class="img-fluid z-depth-0">
                            </th>
                          ...
                          <tr>
                            <th scope="row">
                              <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/6.jpg" alt="" class="img-fluid z-depth-0">
                            </th>
                            <td class="align-middle">
                              <h5 class="mt-3">
...
<!--                              </button>-->
                          ...
                          <tr>
                            <th scope="row">
                              <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/1.jpg" alt="" class="img-fluid z-depth-0">
                            </th>
                            <td class="align-middle">
                              <h5 class="mt-3">
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                <button id="1307077" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/4.png" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/4.png">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-3 col-md-6 mb-4">
                                ...
                                <div class="card collection-card z-depth-1-half">
                                  <!-- Card image -->
                                  <div class="view zoom">
                                    <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Vertical/5.jpg" class="img-fluid"
                                      alt="">
                              ...
                              <div class="col-lg-3 col-md-6 mb-4">
                                ...
                                <div class="card collection-card z-depth-1-half">
                                  <!-- Card image -->
                                  <div class="view zoom">
                                    <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Vertical/8.jpg" class="img-fluid"
                                      alt="">
                              ...
                              <div class="col-lg-3 col-md-6 mb-4">
                                ...
                                <div class="card collection-card z-depth-1-half">
                                  <!-- Card image -->
                                  <div class="view zoom">
                                    <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Vertical/9.jpg" class="img-fluid"
                                      alt="">
                                    <div class="stripe dark">
                                      <a>
                                        <p>Black hat
                              ...
                              <div class="col-lg-3 col-md-6 mb-4">
                                ...
                                <div class="card collection-card z-depth-1-half">
                                  <!-- Card image -->
                                  <div class="view zoom">
                                    <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Vertical/7.jpg" class="img-fluid"
                                      alt="">
                                    <div class="stripe light">
                                      <a>
                                        <p>Sweatshirt
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                <button id="1307084" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/5.png" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/5.png">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>
                                ...
                                <div class="row">
                                  <div class="col-12 col-md-4 mb-2">
                                    ...
                                    <div class="card card-cascade narrower card-ecommerce">
                                      <!-- Card image -->
                                      <div class="view view-cascade overlay">
                                        <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/img%20(39).jpg" class="card-img-top"
                                          alt="sample photo">
                                        <a>
<!--                                          <div class="mask rgba-white-slight"></div>-->
                                        </a>
                                ...
                                <div class="px-1 d-flex justify-content-between align-items-center" >
                                  ...
                                  <div class="col-12 col-md-4 mb-2 clearfix d-none d-md-block">
                                    ...
                                    <div class="card card-cascade narrower card-ecommerce">
                                      <!-- Card image -->
                                      <div class="view view-cascade overlay">
                                        <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/img%20(22).jpg" class="card-img-top"
                                          alt="sample photo">
                                        <a>
<!--                                          <div class="mask rgba-white-slight"></div>-->
                                        </a>
                                ...
                                <div class="card card-cascade narrower card-ecommerce">
                                  <!-- Card image -->
                                  <div class="view view-cascade overlay">
                                    <img src="/showcase-grapes/assets/mdb/img/Photos/Others/img%20(31).jpg" class="card-img-top" alt="sample photo">
                                    <a>
<!--                                      <div class="mask rgba-white-slight"></div>-->
                                    </a>
                                  </div>
                            ...
                            <div class="row">
                              <div class="col-12 col-md-4 mb-2">
                                ...
                                <div class="card card-cascade narrower card-ecommerce">
                                  <!-- Card image -->
                                  <div class="view view-cascade overlay">
                                    <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/img%20(30).jpg" class="card-img-top"
                                      alt="sample photo">
                                    <a>
<!--                                      <div class="mask rgba-white-slight"></div>-->
                                    </a>
                              ...
                              <div class="col-12 col-md-4 mb-2 clearfix d-none d-md-block">
                                ...
                                <div class="card card-cascade narrower card-ecommerce">
                                  <!-- Card image -->
                                  <div class="view view-cascade overlay">
                                    <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/img%20(37).jpg" class="card-img-top"
                                      alt="sample photo">
                                    <a>
<!--                                      <div class="mask rgba-white-slight"></div>-->
                                    </a>
                              ...
                              <div class="col-12 col-md-4 mb-2 clearfix d-none d-md-block">
                                ...
                                <div class="card card-cascade narrower card-ecommerce">
                                  <!-- Card image -->
                                  <div class="view view-cascade overlay">
                                    <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/img%20(31).jpg" class="card-img-top"
                                      alt="sample photo">
                                    <a>
<!--                                      <div class="mask rgba-white-slight"></div>-->
                                    </a>
                            ...
                            <div class="carousel-item">
                              ...
                              <div class="col-12 col-md-4 mb-2">
                                ...
                                <div class="card card-cascade narrower card-ecommerce">
                                  <!-- Card image -->
                                  <div class="view view-cascade overlay">
                                    <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/img%20(38).jpg" class="card-img-top"
                                      alt="sample photo">
                                    <a>
<!--                                      <div class="mask rgba-white-slight"></div>-->
                                    </a>
                              ...
                              <div class="col-12 col-md-4 mb-2 clearfix d-none d-md-block">
                                ...
                                <div class="card card-cascade narrower card-ecommerce">
                                  <!-- Card image -->
                                  <div class="view view-cascade overlay">
                                    <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/belt.jpg" class="card-img-top"
                                      alt="sample photo">
                                    <a>
<!--                                      <div class="mask rgba-white-slight"></div>-->
                                    </a>
                              ...
                              <div class="col-12 col-md-4 mb-2 clearfix d-none d-md-block">
                                ...
                                <div class="card card-cascade narrower card-ecommerce">
                                  <!-- Card image -->
                                  <div class="view view-cascade overlay">
                                    <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/img%20(57).jpg" class="card-img-top"
                                      alt="sample photo">
                                    <a>
<!--                                      <div class="mask rgba-white-slight"></div>-->
                                    </a>
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                <button id="1306128" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/2.png" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/2.png">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-12 mb-4">
        ...
        <div class="card card-cascade wider card-ecommerce">
          <!-- Card image -->
          <div class="view view-cascade overlay">
            <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/img (55).jpg" class="card-img-top"
              alt="sample photo">
            <a>
<!--              <div class="mask rgba-white-slight"></div>-->
            </a>
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        ...
        <div class="card card-cascade wider card-ecommerce">
          <!-- Card image -->
          <div class="view view-cascade overlay">
            <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/img%20(49).jpg" class="card-img-top"
              alt="sample photo">
            <a>
<!--              <div class="mask rgba-white-slight"></div>-->
            </a>
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        ...
        <div class="card card-cascade wider card-ecommerce">
          <!-- Card image -->
          <div class="view view-cascade overlay">
            <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/img (56).jpg" class="card-img-top"
              alt="sample photo">
            <a>
<!--              <div class="mask rgba-white-slight"></div>-->
            </a>
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
            <button id="1306413" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/3.png" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/3.png">
                <a href="#">
                  <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                </a>
            </button>
                          ...
                          <div class="col-lg-3 col-md-6 mb-4 d-flex align-items-stretch">
                            ...
                            <div class="card align-items-center">
                              ...
                              <div class="view overlay">
                                <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Vertical/12.jpg" class="card-img-top"
                                  alt="">
                                <a>
<!--                                  <div class="mask rgba-white-slight"></div>-->
                                </a>
                          ...
                          <div class="col-lg-3 col-md-6 mb-4 d-flex align-items-stretch">
                            ...
                            <div class="card align-items-center">
                              <!-- Card image -->
                              <div class="view overlay">
                                <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Vertical/13.jpg" class="card-img-top"
                                  alt="">
                                <a>
<!--                                  <div class="mask rgba-white-slight"></div>-->
                                </a>
                          ...
                          <div class="col-lg-3 col-md-6 mb-4 d-flex align-items-stretch">
                            ...
                            <div class="card align-items-center">
                              <!-- Card image -->
                              <div class="view overlay">
                                <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Vertical/14.jpg" class="card-img-top"
                                  alt="">
                                <a>
<!--                                  <div class="mask rgba-white-slight"></div>-->
                                </a>
                          ...
                          <div class="col-lg-3 col-md-6 mb-4 d-flex align-items-stretch">
                            ...
                            <div class="card align-items-center">
                              <!-- Card image -->
                              <div class="view overlay">
                                <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Vertical/15.jpg" class="card-img-top"
                                  alt="">
                                <a>
<!--                                  <div class="mask rgba-white-slight"></div>-->
                                </a>
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                    <button id="1307088" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                        <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/6.png" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/6.png">
                        <a href="#">
                          <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                        </a>
                    </button>
                                      ...
                                      <div class="tab-pane fade" id="tabCheckoutAddons123" role="tabpanel">
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-md-5 mb-4">
                                            ...
                                            <img src="/showcase-grapes/assets/mdb/img/Photos/Others/images/43.jpg" class="img-fluid z-depth-1-half"
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-md-5 mb-4">
                                            ...
                                            <img src="/showcase-grapes/assets/mdb/img/Photos/Others/images/44.jpg" class="img-fluid z-depth-1-half"
                                              alt="Second sample image">
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                <button id="1349717" type="button" class="btn btn-primary overlay z-depth-1 mb-4">                  
                     <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/10.png" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/10.png">
                     <a href="#">
                       <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                     </a>
                </div>
                                ...
                                <div class="row h-100 d-flex align-items-center">
                                  ...
                                  <div class="col-lg-6">
                                    ...
                                    <div id="carousel-thumb" class="carousel slide carousel-thumbnails" data-ride="carousel">
                                      ...
                                      <div class="carousel-inner text-center text-md-left" role="listbox">
                                        <div class="carousel-item active">
                                          <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/17.jpg" alt="First slide" class="img-fluid">
                                        </div>
                                        <div class="carousel-item">
                                          <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/18.jpg" alt="Second slide" class="img-fluid">
                                        </div>
                                        <div class="carousel-item">
                                          <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/19.jpg" alt="Third slide" class="img-fluid">
                                        </div>
                                      </div>
                                      <!--/.Slides-->
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                <button id="1404008" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/11.png" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/11.png">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-4 col-md-12 mb-4">
                                  ...
                                  <a href="" class="waves-effect waves-light"><img
                                      src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/14.jpg" class="img-fluid"
                                      alt=""></a>
                                ...
                                <div class="col-lg-4 col-md-6 mb-4">
                                  ...
                                  <a href="" class="waves-effect waves-light"><img
                                      src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/13.jpg" class="img-fluid"
                                      alt=""></a>
                                ...
                                <div class="col-lg-4 col-md-6 mb-4">
                                  ...
                                  <a href="" class="waves-effect waves-light"><img
                                      src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/12.jpg" class="img-fluid"
                                      alt=""></a>
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                <button id="1404060" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/12.png" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/12.png">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>
                            ...
                            <section class="text-center">
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-4 col-md-12 mb-4">
                                  ...
                                  <a href="" class="waves-effect waves-light"><img
                                      src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/16.jpg" class="img-fluid"
                                      alt=""></a>
                                ...
                                <div class="col-lg-4 col-md-6 mb-4">
                                  ...
                                  <a href="" class="waves-effect waves-light"><img
                                      src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/11.jpg" class="img-fluid"
                                      alt=""></a>
                                ...
                                <div class="col-lg-4 col-md-6 mb-4">
                                  ...
                                  <a href="" class="waves-effect waves-light"><img
                                      src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/10.jpg" class="img-fluid"
                                      alt=""></a>
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                <button id="1349707" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/8.png" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/8.png">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>
                      ...
                      \t<div class="row">
                          ...
                          <div class="col-md-4 mb-4">
                            ...
                            <div class="card">
                              ...
                              <!--Card image-->
                              <div class="view overlay">
                                <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/shoes%20(2).jpg" class="card-img-top" alt="">
                                <a>
<!--                                  <div class="mask rgba-white-slight waves-effect waves-light"></div>-->
                          ...
                          <div class="col-md-4 mb-4">
                            ...
                            <div class="card">
                              ...
                              <!--Card image-->
                              <div class="view overlay">
                                <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/belt.jpg" class="card-img-top" alt="">
                                <a>
<!--                                  <div class="mask rgba-white-slight waves-effect waves-light"></div>-->
                                </a>
                              </div>
                          ...
                          <div class="col-md-4 mb-4">
                            ...
                            <div class="card">
                              ...
                              <!--Card image-->
                              <div class="view overlay">
                                <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/img%20(4).jpg" class="card-img-top" alt="">
                                <a>
<!--                                  <div class="mask rgba-white-slight waves-effect waves-light"></div>-->
                                </a>
                              </div>
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                <button id="1404084" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/13.png" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/13.png">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-4 col-md-12 mb-4">
                                  ...
                                  <div class="card">
                                    ...
                                    <!-- Card image -->
                                    <div class="view overlay">
                                      <img class="card-img-top" src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/shoes%20(6).jpg"
                                        alt="Card image cap">
                                      <a href="#!">
<!--                                        <div class="mask rgba-white-slight"></div>-->
                                      </a>
                                ...
                                <div class="col-lg-4 col-md-6 mb-4">
                                  ...
                                  <div class="card">
                                    ...
                                    <!-- Card image -->
                                    <div class="view overlay">
                                      <img class="card-img-top" src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/shoes%20(7).jpg"
                                        alt="Card image cap">
                                      <a href="#!">
<!--                                        <div class="mask rgba-white-slight"></div>-->
                                      </a>
                                ...
                                <div class="col-lg-4 col-md-6 mb-4">
                                  ...
                                  <div class="card">
                                    ...
                                    <!-- Card image -->
                                    <div class="view overlay">
                                      <img class="card-img-top" src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/shoes%20(8).jpg"
                                        alt="Card image cap">
                                      <a href="#!">
<!--                                        <div class="mask rgba-white-slight"></div>-->
                                      </a>
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                <button id="1404144" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/14.png" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/14.png">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                <button id="1404899" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/15.png" class="img-fluid" alt="" 
                    src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/15.png">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                <button id="1451118" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/18.png" class="img-fluid" alt="" 
                    src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/18.png">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>
                        ...
                        <div class="row">
                          ...
                          <div class="col-12">
                            ...
                            <div class="view zoom z-depth-1 rounded mb-4">
                              <a href="#!">
                                <img src="/showcase-grapes/assets/mdb/img/Photos/Others/product1.jpg" class="img-fluid" alt="sample image">
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                <button id="1445828" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/16.png" class="img-fluid" alt="" 
                    src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/16.png">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-lg-4 col-md-12 mb-4 d-flex align-items-stretch">
                                        ...
                                        <div class="card card-ecommerce">
                                          ...
                                          <div class="view overlay">
                                            <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/13.jpg" class="img-fluid" alt="sample image">
                                            <a>
<!--                                              <div class="mask rgba-white-slight"></div>-->
                                            </a>
                                          </div>
...
<!--                                              </div>-->
                                      ...
                                      <div class="col-lg-4 col-md-6 mb-4 d-flex align-items-stretch">
                                        ...
                                        <div class="card card-ecommerce">
                                          ...
                                          <div class="view overlay">
                                            <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/2.jpg" class="img-fluid" alt="sample image">
                                            <a>
<!--                                              <div class="mask rgba-white-slight"></div>-->
                                            </a>
                                          </div>
...
<!--                                              </div>-->
                                      ...
                                      <div class="col-lg-4 col-md-6 mb-4 d-flex align-items-stretch">
                                        ...
                                        <div class="card card-ecommerce">
                                          ...
                                          <div class="view overlay">
                                            <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/4.jpg" class="img-fluid" alt="sample image">
                                            <a>
<!--                                              <div class="mask rgba-white-slight"></div>-->
                                            </a>
                                          </div>
                                    ...
                                    <div class="row mb-3">
                                      ...
                                      <div class="col-lg-4 col-md-12 mb-4 d-flex align-items-stretch">
                                        ...
                                        <div class="card card-ecommerce">
                                          ...
                                          <div class="view overlay">
                                            <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/8.jpg" class="img-fluid" alt="sample image">
                                            <a>
<!--                                              <div class="mask rgba-white-slight"></div>-->
                                            </a>
                                          </div>
...
<!--                                            </ul>-->
                                      ...
                                      <div class="col-lg-4 col-md-6 mb-4 d-flex align-items-stretch">
                                        ...
                                        <div class="card card-ecommerce">
                                          ...
                                          <div class="view overlay">
                                            <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/7.jpg" class="img-fluid" alt="sample image">
                                            <a>
<!--                                              <div class="mask rgba-white-slight"></div>-->
                                            </a>
                                          </div>
...
<!--                                            </ul>-->
                                      ...
                                      <div class="col-lg-4 col-md-6 mb-4 d-flex align-items-stretch">
                                        ...
                                        <div class="card card-ecommerce">
                                          ...
                                          <div class="view overlay">
                                            <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/9.jpg" class="img-fluid" alt="sample image">
                                            <a>
<!--                                              <div class="mask rgba-white-slight"></div>-->
                                            </a>
                                          </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-lg-4 col-md-12 mb-4 d-flex align-items-stretch">
                                        ...
                                        <div class="card card-ecommerce">
                                          ...
                                          <div class="view overlay">
                                            <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/10.jpg" class="img-fluid" alt="sample image">
                                            <a>
<!--                                              <div class="mask rgba-white-slight"></div>-->
                                            </a>
                                          </div>
...
<!--                                            </ul>-->
                                      ...
                                      <div class="col-lg-4 col-md-6 mb-4 d-flex align-items-stretch">
                                        ...
                                        <div class="card card-ecommerce">
                                          ...
                                          <div class="view overlay">
                                            <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/11.jpg"class="img-fluid" alt="sample image">
                                            <a>
<!--                                              <div class="mask rgba-white-slight"></div>-->
                                            </a>
                                          </div>
...
<!--                                            </ul>-->
                                      ...
                                      <div class="col-lg-4 col-md-6 mb-4 d-flex align-items-stretch">
                                        ...
                                        <div class="card card-ecommerce">
                                          ...
                                          <div class="view overlay">
                                            <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/3.jpg" class="img-fluid" alt="sample image">
                                            <a>
<!--                                              <div class="mask rgba-white-slight"></div>-->
                                            </a>
                                          </div>
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                <button id="1451606" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/19.png" class="img-fluid" alt="" 
                    src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/19.png">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                <button id="1445946" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/17.png" class="img-fluid" alt="" 
                    src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/17.png">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>
                              ...
                              <div class="card-body">
                                <div class="row align-items-center">
                                  <div class="col-6 px-0">
                                    <a>
                                      <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/1.jpg"
                                        class="img-fluid">
                                    </a>
                                  </div>
                            ...
                            <div class="card hoverable mb-4">
                              <div class="card-body">
                                <div class="row align-items-center">
                                  <div class="col-6 px-0">
                                    <a>
                                      <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/10.jpg"
                                        class="img-fluid">
                                    </a>
                                  </div>
                                  <div class="col-6 text-left">
                            ...
                            <div class="card hoverable mb-4">
                              <div class="card-body">
                                <div class="row align-items-center">
                                  <div class="col-6 px-0">
                                    <a>
                                      <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/3.jpg"
                                        class="img-fluid">
                                    </a>
                                  </div>
                                  <div class="col-6 text-left">
                            ...
                            <div class="card hoverable mb-4">
                              <div class="card-body">
                                <div class="row align-items-center">
                                  <div class="col-6 px-0">
                                    <a>
                                      <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/4.jpg"
                                        class="img-fluid">
                                    </a>
                                  </div>
                                  <div class="col-6 text-left">
                            ...
                            <div class="card hoverable mb-4">
                              <div class="card-body">
                                <div class="row align-items-center">
                                  <div class="col-6 px-0">
                                    <a>
                                      <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/5.jpg"
                                        class="img-fluid">
                                    </a>
                                  </div>
                                  <div class="col-6 text-left">
                            ...
                            <div class="card hoverable mb-4">
                              <div class="card-body">
                                <div class="row align-items-center">
                                  <div class="col-6 px-0">
                                    <a>
                                      <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/6.jpg"
                                        class="img-fluid">
                                    </a>
                                  </div>
                                  <div class="col-6 text-left">
                            ...
                            <div class="card hoverable mb-4">
                              <div class="card-body">
                                <div class="row align-items-center">
                                  <div class="col-6 px-0">
                                    <a>
                                      <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/7.jpg"
                                        class="img-fluid">
                                    </a>
                                  </div>
                                  <div class="col-6 text-left">
                            ...
                            <div class="card hoverable mb-4">
                              <div class="card-body">
                                <div class="row align-items-center">
                                  <div class="col-6 px-0">
                                    <a>
                                      <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/8.jpg"
                                        class="img-fluid">
                                    </a>
                                  </div>
                                  <div class="col-6 text-left">
                            ...
                            <div class="card hoverable mb-4">
                              <div class="card-body">
                                <div class="row align-items-center">
                                  <div class="col-6 px-0">
                                    <a>
                                      <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/9.jpg"
                                        class="img-fluid">
                                    </a>
                                  </div>
                                  <div class="col-6 text-left">
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                <button id="1454032" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/23.png" class="img-fluid" alt=""
                     src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/23.png">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>
                  ...
                  <div id="carousel-example-2" class="carousel slide carousel-fade" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                      <div class="carousel-item active">
                        <div class="view">
                          <a href="#!">
                          \t<img class="d-block w-100" src="/showcase-grapes/assets/mdb/img/Photos/Others/ecommerce4.jpg" alt="First slide">
                      ...
                      <div class="carousel-item">
                        ...
                        <div class="view">
                          <a>
                          \t<img class="d-block w-100" src="/showcase-grapes/assets/mdb/img/Photos/Others/ecommerce2.jpg" alt="Second slide">
                          \t<div class="mask rgba-white-slight text-center d-flex align-items-center justify-content-center">
                            \t<div class="row">
                              \t<div class="col-12">
                      ...
                      <div class="carousel-item">
                        ...
                        <div class="view">
                          <a>
                          \t<img class="d-block w-100" src="/showcase-grapes/assets/mdb/img/Photos/Others/ecommerce3.jpg" alt="Third slide">
                          \t<div class="mask rgba-white-slight text-center d-flex align-items-center justify-content-center">
                            \t<div class="row">
                              \t<div class="col-12">
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                <button id="1451648" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/20.png" class="img-fluid" alt="" 
                    src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/20.png">
                    <a href="#">
<!--                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>-->
                    </a>
                </button>
                  ...
                  <div class="col-lg-6">
                    ...
                    <div id="carousel-thumb1" class="carousel slide carousel-fade carousel-thumbnails mb-5 pb-4" data-ride="carousel">
                      ...
                      <div class="carousel-inner text-center text-md-left" role="listbox">
                        ...
                        <div class="carousel-item">
                          <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/2.jpg"
                            alt="Second slide" class="img-fluid">
                        </div>
                        <div class="carousel-item">
                          <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/20.jpg"
                            alt="Third slide" class="img-fluid">
                        </div>
                      </div>
                      <!--/.Slides-->
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="mdb-lightbox no-margin row d-flex justify-content-center align-items-center">
                          <figure class="col-md-4">
                            <a href="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/1.jpg"
                              data-size="1600x1067">
                              <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/1.jpg"
                                class="img-fluid">
                            </a>
                          ...
                          <figure class="col-md-4">
                            <a href="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/2.jpg"
                              data-size="1600x1067">
                              <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/2.jpg"
                                class="img-fluid">
                            </a>
                          ...
                          <figure class="col-md-4">
                            <a href="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/20.jpg"
                              data-size="1600x1067">
                              <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/20.jpg"
                                class="img-fluid">
                            </a>
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                <button id="1451751" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/21.png" class="img-fluid" alt="" src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/21.png">
                    <a href="#">
<!--                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>-->
                    </a>
                </button>
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                <button id="1451782" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/22.png" class="img-fluid" alt="" 
                    src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/22.png">
                    <a href="#">
<!--                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>-->
                    </a>
                </button>
            ...
            <div class="container my-5">
              ...
              <section class="dark-grey-text mb-5">
                ...
                <div class="media mb-3">
                  ...
                  src="/showcase-grapes/assets/mdb/img/Photos/Avatars/img (8).jpg" alt="Generic placeholder image">
                ...
                <div class="media mb-3">
                  <img class=" card-img-100 rounded-circle z-depth-1-half d-flex mr-3" 
                  src="/showcase-grapes/assets/mdb/img/Photos/Avatars/img (28).jpg" alt="Generic placeholder image">
                  <div class="media-body text-left">
                    <a>
                ...
                <div class="media">
                  <img class=" card-img-100 rounded-circle z-depth-1-half d-flex mr-3"
                  src="/showcase-grapes/assets/mdb/img/Photos/Avatars/img (30).jpg" alt="Generic placeholder image">
                  <div class="media-body text-left">
                    <a>
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                <button id="1456101" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/30.png" class="img-fluid" alt="" 
                    src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/30.png">
                    <a href="#">
<!--                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>-->
                    </a>
                </button>
                ...
                <div class="table-responsive">
                  <table class="table product-table table-cart-v-1">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <th scope="row">
                          <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/13.jpg" alt=""
...
<!--                          <span class="qty">1 </span>-->
                      ...
                      <tr>
                        <th scope="row">
                          <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/6.jpg" alt=""
                            class="img-fluid z-depth-0">
                        </th>
                        <td>
                          <h5 class="mt-3">
...
<!--                          <span class="qty">3 </span>-->
                      ...
                      <tr>
                        <th scope="row">
                          <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/1.jpg" alt=""
                            class="img-fluid z-depth-0">
                        </th>
                        <td>
                          <h5 class="mt-3">
    ...
    $('#sidebar-ecommerces-designs .app-content--sidebar__content').append(
        `
                <button id="1455203" type="button" class="btn btn-primary overlay z-depth-1 mb-4">
                    <img data-src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/26.png" class="img-fluid" alt="" 
                    src="/showcase-grapes/assets/mdb/img/blocks/ecommerce/26.png">
                    <a href="#">
                      <div class="mask rgba-blue-slight waves-effect waves-light"></div>
                    </a>
                </button>
                      ...
                      <div class="col-lg-4 col-md-12">
                        ...
                        <a class="card z-depth-0 mb-4" data-toggle="modal" data-target="#basicExampleModal">
                          <div class="card-body">
                            <div class="row align-items-center">
                              <div class="col-6 px-0">
                                <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/1.jpg" class="img-fluid">
                              </div>
                              <div class="col-6 text-left">
...
<!--                                </ul>-->
                        ...
                        <a class="card z-depth-0 mb-4" data-toggle="modal" data-target="#basicExampleModal">
                          <div class="card-body">
                            <div class="row align-items-center">
                              <div class="col-6 px-0">
                                <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/10.jpg" class="img-fluid">
                              </div>
                              <div class="col-6 text-left">
...
<!--                                </ul>-->
                        ...
                        <a class="card z-depth-0 mb-4" data-toggle="modal" data-target="#basicExampleModal">
                          <div class="card-body">
                            <div class="row align-items-center">
                              <div class="col-6 px-0">
                                <img src="/showcase-grapes/assets/mdb/img/Photos/Horizontal/E-commerce/Products/3.jpg" class="img-fluid">
                              </div>
                              <div class="col-6 text-left">
                                <p class="mb-0">
                                  <strong>iMac 27"</strong>
